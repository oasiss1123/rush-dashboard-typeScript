...
export async function getPreorders() {
  ...
  return axios({
    headers,
    method: "GET",
    url: "https://dev.rushs.app/api/preorders",
  });
}
...
export async function getPreorder(id: number) {
  ...
  return axios({
    headers,
    method: "GET",
    url: `https://dev.rushs.app/api/preorders/${id}`,
  });
}
...
export async function deletePreorder(id: number) {
  ...
  return axios({
    headers,
    method: "DELETE",
    url: `https://dev.rushs.app/api/preorders/delete/${id}`,
  });
}
...
export async function createPreorder(data: any) {
  ...
  return axios({
    headers,
    method: "POST",
    url: `https://dev.rushs.app/api/preorders/new`,
    data,
  });
}

export async function editPreorder(data: any, id: number) {
  const headers = {
    "X-Token":
      "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJicmFuY2hfdWlkIjoiMDAwMDAwMDAtMDAwMC0wMDAwLTAwMDAtMDAwMDAwMDAwMDAwIiwiZW1haWwiOiJhZG1pbkBqYW1lcy5jbyIsImV4cCI6MTY1NjY0NDc1OSwiaWF0IjoxNjU2MDM5OTU5LCJpZCI6MywibmFtZSI6ImFkbWluSmFtZXMgQm91bGFuZ2VyaWUiLCJzdWIiOjN9.1zhttgc9C88mhhKFxvdEirXdVmxFD8iDEx2nodKgV0N6rj3mSzuXXxj_vpqKYwfjZg6rNoEoHMY3QcXiOnYIpAWuih8U2jP-Sl04mVutHX_AxU1sRFvVp40GFVHnosf6HEFArlRWDx7693kksaIRHXVEf3Re2cvFteY3T00ZrqM",
    refresh_token:
  ...
  return axios({
    headers,
    method: "PUT",
    url: `https://dev.rushs.app/api/preorders/edit/${id}`,
    data,
  });
}
